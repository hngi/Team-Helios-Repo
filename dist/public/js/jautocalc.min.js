!function (e) {
  ...
  function s(e) {
    ...
    for (; null != (r = n.exec(e));) t.push(r[1]);
  ...
  function a(e, t, n) {
    ...
    for (let e = r.length - 1; e >= 0; e--) u = r.charAt(e), -1 != o.a.inArray(u, c) ? a = u + a : "" == i && -1 != o.a.inArray(u, t.decimalOpts) ? (f = e, i = u, a = "." + a) : "" == l && -1 != o.a.inArray(u, t.thousandOpts) ? l = u : "" != d || -1 != o.a.inArray(u, s) || 0 != e && e != r.length - 1 || (d = u, g = e);
  ...
  function f(e) {
    ...
    for (n = 0; "0123456789".indexOf(e.string.substr(e.offset, 1)) >= 0 && e.offset < e.string.length;) e.offset++;

    if ("." == e.string.substr(e.offset, 1)) for (e.offset++; "0123456789".indexOf(e.string.substr(e.offset, 1)) >= 0 && e.offset < e.string.length;) e.offset++;
    ...
    if (null != (r = /^[a-z_][a-z0-9_]*/i.exec(e.string.substr(e.offset)))) {
      const t = r[0];
      if (e.offset += t.length, t in i) return i[t];
      throw e.error = "Semantic error: unknown variable '" + t + "'", new Error("unknownVar");
    }
  ...
  function d(e) {
    ...
    for (;;) {
      ...
      for (; r.precedence < t[t.length - 1].precedence || r.precedence == t[t.length - 1].precedence && "L" == r.assoc;) {
        const e = t.pop();
        if (!e.exec) return n;
        n = e.exec(e.value, n);
      }
  ...
  function g(e, t, n, r, o, s, u) {
    ...
    for (const t in u) {
      const n = u[t],
            s = new RegExp(n.rgx, "gi");
      let c;

      for (; null != (c = s.exec(e));) {
        const t = n.exec(c[1], r, o, f);
        e = e.replace(new RegExp(n.rgx, "gi"), t);
      }
    }
    ...
    for (let s = 0; s < t.length; s++) {
      const u = t[s],
            i = a($(c(u), r).val(), o, f);
      if (0 == i.length) return void n.val("").change();
      e = e.replace(new RegExp("{" + u + "}", "g"), i);
    }
    ...
    const l = function (e, t) {
      ...
      try {
        ...
        return t.showParseError && alert(`${n.error} (${e}):\n${n.string.substr(0, n.offset)}<*>${n.string.substr(n.offset)}`), null;
      }
    }(e, o);

    i = (i = (i = (i = (i = null == l ? "" : function (e, t) {
      const n = (e.toFixed(t) + "").split("."),
            r = n.length > 1 ? "." + n[1] : "",
            o = /(\d+)(\d{3})/;
      let s = n[0];

      for (; o.test(s);) s = s.replace(o, "$1,$2");
  ...
  function y(e, t, n, r) {
    return e.each(function () {
      ...
      $("[" + t.attribute + "]:not([" + h + "])", e).each(function () {
        ...
        for (let t = 0; t < u.length; t++) if (0 == $(c(u[t]), e).length) return;

        t.keyEventsFire && (x += " keyup keydown keypress");
        const i = x.split(" ").join("." + p + " ");
    ...
    sum: {
      ...
      exec: function (e, t, n, r) {
        ...
        return o()(c(e), t).each(function () {
          const e = parseFloat(a(o()(this).val(), n, r));
          s += e;
        }), s;
      }
    },
  ...
  o.a.fn.jAutoCalc = Object.assign(function (...e) {
    let t = "init",
    ...
    for (const r of e) "string" == typeof r && (t = r.toString()), "object" == typeof r && (n = o.a.extend(n, r));

    const s = o.a.extend({}, b, n.funcs),
...
//# sourceMappingURL=jautocalc.min.js.map